...
P.S. Для более краткого изложения в отчете используются имена - Лена, Настя, Даша (имя устройств).
...
1. Для начала убедились, что соединение выполняется успешно. Затем с устройста Даши перенесли картинку на устройство Насти (пользуясь терминалом Лены):
   ...
   ![image](https://github.com/luckyapin/clouds/assets/87613601/5b2cb4d6-186f-4b58-b3d6-35d8912ec507)
